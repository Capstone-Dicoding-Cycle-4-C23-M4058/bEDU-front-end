...
const API_ENDPOINT = {
  ...
  PROFILE_ADMIN: `${CONFIG.BASE_URL}admin/profile`,
  PROFILE_USER: `${CONFIG.BASE_URL}user/profile`,
  EDIT_ADMIN: `${CONFIG.BASE_URL}admin`,
  EDIT_USER: `${CONFIG.BASE_URL}user`,
  ...
  CHANGE_PASSWORD_ADMIN: `${CONFIG.BASE_URL}admin/change-password`,
  CHANGE_PASSWORD_USER: `${CONFIG.BASE_URL}user/change-password`,
};
